 ...
 * @description This function gets all games. A successful request will return an array of [Game Objects](https://docs.mod.io/#get-games-2). We recommended reading the [filtering documentation](https://docs.mod.io/#filtering) to return only the records you want.
 * 
