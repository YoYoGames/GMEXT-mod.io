 ...
 * 
 * @param {function|method} _callback_success The function to execute when the request is successful.
 * @param {function|method} _callback_failed The function to execute when the request failed.
 * 
 ...
 * 
 * @param {string} _appdata The Steam user's [Encrypted App Ticket](https://partner.steamgames.com/doc/features/auth#encryptedapptickets) provided by the Steamworks SDK, as a [base64-encoded string](https://manual.yoyogames.com/GameMaker_Language/GML_Reference/File_Handling/Encoding_And_Hashing/base64_encode.htm).
 * @param {struct} _optionals A struct that can contain one or more of the following variables: 
 * 
 * * email (${type.string}) The user's email address (optional but recommended to help users recover lost accounts). If supplied, and the respective user doesn't have an email registered for their account mod.io will send a confirmation email to confirm they have ownership of the specified email.
 ...
 * 
 * @param {function|method} _callback_success The function that is triggered when the request is successful.
 * @param {function|method} _callback_failed The function that is triggered when the request failed.
 * 
 ...
 * 
 * @param {string} _xbox_token A valid Xbox Live token
 * @param {struct} _optionals A struct that can contain one or more of the following variables: 
 * 
 ...
 * 
 * @param {string} _auth_code The auth code returned from the PlayStation Network API.
 * @param {struct} _optionals A struct that can contain one or more of the following variables: 
 * 
 ...
 * 
 * @param {string} _id_token The NSA ID supplied by the Nintendo Switch SDK.
 * @param {struct} _optionals A struct that can contain one or more of the following variables: 
 * 
 ...
 * 
 * @param {string} _device The Meta Quest device being used for authentication.
 * @param {string} _nonce The nonce provided by calling [ovr_User_GetUserProof()](https://developer.oculus.com/documentation/platform/latest/concepts/dg-ownership/) from the Meta Quest SDK.
 * @param {real} _user_id The user's Meta Quest ID providing by calling [ovr_GetLoggedInUserID()](https://developer.oculus.com/documentation/platform/latest/concepts/dg-ownership/) from the Meta Quest SDK.
 * @param {string} _access_token The user's access token, providing by calling [ovr_User_GetAccessToken()](https://developer.oculus.com/documentation/platform/latest/concepts/dg-ownership/) from the Meta Quest SDK. mod.io uses this access token on the first login only to obtain the user's alias and is not saved on the mod.io servers.
 * @param {struct} _optionals A struct that can contain one or more of the following variables: 
 * 
 * * email (${type.string}) The user's email address. If supplied, and the respective user doesn't have an email registered for their account, mod.io will send a confirmation email to confirm they have ownership of the specified email.
 * 
 ...
 * 
 * @param {string} _appdata The GOG Galaxy user's [Encrypted App Ticket](https://cdn.gog.com/open/galaxy/sdk/1.133.3/Documentation/classgalaxy_1_1api_1_1IUser.html#a352802aab7a6e71b1cd1b9b1adfd53d8). You can get this using the GOG extension's `GOG_User_GetEncryptedAppTicket` function.
 * @param {struct} _optionals A struct that can contain one or more of the following variables: 
 * 
 * * email (${type.string}) The user's email address. If supplied, and the respective user doesn't have an email registered for their account, mod.io will send a confirmation email to confirm they have ownership of the specified email.
 * 
 ...
 * 
 * @param {string} _access_token The access token returned by the [`EpicGames_Auth_CopyUserAuthToken`](https://github.com/YoYoGames/GMEXT-EpicOnlineServices/wiki/Auth#EpicGames_Auth_CopyUserAuthToken) function of the [Epic online Services extension](https://github.com/YoYoGames/GMEXT-EpicOnlineServices).
 * @param {struct} _optionals A struct that can contain one or more of the following variables: 
 * 
 ...
 * 
 * @param {string} _id_token The `id_token` value [returned from Google](https://developers.google.com/identity/sign-in/web/backend-auth#calling-the-tokeninfo-endpoint) after you have authenticated a user via the Google OAuth2 flow.
 * @param {struct} _optionals A struct that can contain one or more of the following variables: 
 * 
 * * email (${type.string}) The user's email address. If supplied, and the respective user doesn't have an email registered for their account, mod.io will send a confirmation email to confirm they have ownership of the specified email.
 * 
 ...
 * 
 * @param {string} _id_token The ID token issued by the configured identity provider.
 * @param {struct} _optionals A struct that can contain one or more of the following variables: 
 * 
 * * email (${type.string}) The user's email address. If supplied, and the respective user doesn't have an email registered for their account, mod.io will send a confirmation email to confirm they have ownership of the specified email.
 * 
 ...
 * <br />
 * 
 * This function requests a security code for a user, identified by their e-mail which can then be [exchanged](https://docs.mod.io/#email) for an access token. A successful request will return a ${struct.Message} struct.
 * 
 * > To use this functionality you **must** use your game's api_key from your game's profile on mod.io.
 * 
 * @param {string} _email An email address the user can access to retrieve the security code. This parameter should also be URL encoded before the request is sent.
 * 
 * @param {function|method} _callback_success The function to trigger when the request is successful.
 * @param {function|method} _callback_failed The function to trigger when the request failed.
 * 
 ...
 * 
 * @param {string} _security_code The alphanumeric security code.
 * @param {struct} _optionals A struct that can contain one or more of the following variables: 
 * 
 * * date_expires (${type.real}) The Unix timestamp of the date on which the returned token will expire. The value cannot be higher than the default value which is a common year (unix timestamp + 31536000 seconds). Using a token after its expiry time has elapsed will result in a `401 Unauthorized` response.
 * 
