 ...
 * 
 * This function subscribes the *authenticated user* to a corresponding mod. No body parameters are required for this action. A successful request will return the ${struct.Mod} struct of the newly subscribed mod.
 * 
 ...
 * 
 * This function unsubscribes the *authenticated user* from the corresponding mod. No body parameters are required for this action. A successful request will return `204 No Content`.
 * 
