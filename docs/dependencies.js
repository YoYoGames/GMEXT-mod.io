 ...
 * <br />
 * 
 * This function gets all the dependencies the chosen mod has selected. This is useful if a mod requires other mods to be installed for it to run. A successful request will return an array of ${struct.ModDependenciesObject}.
 *
